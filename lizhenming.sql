...
CREATE LOGIN lizhenming
WITH PASSWORD='lizhenming',
...
CREATE USER [usr1] FOR LOGIN [lizhenming]
CREATE USER [usr2] FOR LOGIN [lizhenming]
CREATE USER [usr3] FOR LOGIN [lizhenming]
GO 
